...
**Live:** [https://relaxed-weasel-photoview.cloud.nexlayer.ai](https://relaxed-weasel-photoview.cloud.nexlayer.ai)  
...
**photoview** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/viktorstrate/photoview:2
    path: /
    servicePorts:
    - 80
    vars:
      PHOTOVIEW_DATABASE_DRIVER: mysql
      PHOTOVIEW_MYSQL_URL: "photoview:photoview@tcp(mysql.pod:3306)/photoview"
      PHOTOVIEW_LISTEN_IP: "0.0.0.0"
      PHOTOVIEW_LISTEN_PORT: "80"
      PHOTOVIEW_MEDIA_CACHE: /app/cache
    volumes:
    - name: photoview-photos
      mountPath: /photos
      size: 20Gi
